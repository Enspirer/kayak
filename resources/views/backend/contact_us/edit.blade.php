                                    ...
                                    <div class="col-12">
                                        <table class="table table-hover table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="font-weight: 600; font-size:16px;">Company:</td>
                                                    <td style="font-size:16px;">{{ $contact_us->company }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight: 600; font-size:16px;">Telephone:</td>
                                                    <td style="font-size:16px;">{{ $contact_us->telephone }}</td>
                                                </tr>
                                                <tr>

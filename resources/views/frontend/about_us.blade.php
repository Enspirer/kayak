            ...
            <div class="row">
                <div class="col-6">
                    <div class="card custom-shadow">
                        <div class="card-body p-4 position-relative">
                            <p class="display-2 position-absolute" style="opacity: 0.2; opacity: 0.07; top: -2.8rem; left: -0.5rem;">VISION</p>
                ...
                <div class="col-6">
                    <div class="card custom-shadow" style="height: 14.9rem;">
                        <div class="card-body p-4 position-relative">
                            <p class="display-2 position-absolute" style="opacity: 0.2; opacity: 0.07; top: -2.8rem; left: 0rem;">MISSION</p>

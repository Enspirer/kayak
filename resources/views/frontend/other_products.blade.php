                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item mb-4">
                        <h2 class="accordion-header" id="headingOne">
                            <button onclick="removeActiveOther()"  class="accordion-button fw-bolder" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="accordion-body">
                                <ul class="nav flex-column">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active btn fw-bold inner-nav-link" id="pills-orthopaedic-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-orthopaedic" type="button"
                                            role="tab" aria-controls="pills-orthopaedic">Orthopaedic</button>
                                    </li>
                                    <!-- <li class="nav-item" role="presentation">
                    ...
                    <div class="accordion-item mb-4">
                        <h2 class="accordion-header" id="headingTwo">
                            <button onclick="removeActiveOther()"  class="accordion-button collapsed fw-bolder" type="button" data-bs-toggle="collapse"
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div class="accordion-body">
                                <ul class="nav flex-column">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link  btn fw-bold inner-nav-link" id="pills-mosquito-dunk-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-mosquito-dunk" type="button"
                                            role="tab" aria-controls="pills-mosquito-dunk">Mosquito Dunks</button>
                                    </li>
                                    <!-- <li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade" id="pills-mosquito-dunk" aria-labelledby="pills-mosquito-dunk-tab">
                    <div class="row">
                        ...
                        <div class="list-and-more-wrapper">
                            ...
                            <a class="other-more-link" href="{{ url('pdf/other-products/Summit_Catalog-fnl-web.pdf') }}"

    ...
    <tr>
      <td align="center" style="padding:0;">
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;" align="left">
                    <h1 style="font-size:20px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Kayak Surgi Pharma - Inquiry</h1>
                  </td>
                ...
                <tr>
                  <td style="padding:0 0 30px 0;color:#153643;">
                    ...
                    <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Thank you for your interest in our product. One of our member will get back in touch with you soon.<br>
                        Have a great day!</p>
                  </td>
                </tr>
                <tr>
                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      <tr>
                        <td style="width:30%;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="color: black; margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Company Name:</p>
          ...
          <tr>
            <td style="padding:30px;background:rgb(67, 58, 7)">

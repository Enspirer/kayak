...
<body align="center" style="background-color: #F0F0F0; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #333333;">
    
<br><br>
    <h1 style="font-size: 20px;">Kayak Surgi Pharma - Contact Us</h1><br>
    ...
    <table width="70%" cellpadding="0" cellspacing="0" border="0" align="center">
        ...
        <tr>            
            <td width="20%" cellpadding="0" cellspacing="0">  
                <p align="left"><b>Company:</b> </p>  
                <hr>        
            </td>
            <td  cellpadding="0" cellspacing="0">  
                <p align="left">{{ $details['company'] }}</p> 
                <hr>                
            </td>
        </tr>
        <tr>            
            <td width="20%" cellpadding="0" cellspacing="0">  
                <p align="left"><b>Phone Number:</b> </p>  
                <hr>        
            </td>
            <td  cellpadding="0" cellspacing="0">  
